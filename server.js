...
app.use(
  cors({
    origin: ["http://localhost:3001" ,"http://localhost:4001", "https://social-auth-role-based.onrender.com" ,"https://client-social-auth-role-based.vercel.app" , "https://boss-search-engine.vercel.app"],
